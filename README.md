...
Check the folder example/, the file called input.pdf (which is actually the famous paper "Attention Is All You Need") is the file given for our app, and the result is [output.ipynb](https://github.com/oguzhan-sinik/JupyPaper/blob/main/example/output.ipynb).
